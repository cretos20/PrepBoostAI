...
const Home = () => {
    ...
    const handleResumeChange = (event) => {
        ...
        if (file.type !== "application/pdf" && !file.name.toLowerCase().endsWith(".pdf")) {
            setResumeFile(null)
            event.target.value = ""
            setError("Please upload a PDF resume. DOCX is not supported by the backend yet.")
            return
        }
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            setError(err.message || "Could not generate the interview report.")
        }
    }
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                <input onChange={handleResumeChange} hidden type='file' id='resume' name='resume' accept='application/pdf,.pdf' />
                            </label>
                        </div>
